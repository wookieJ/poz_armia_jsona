...
//    @Test
//    public void searchQualityTest() {
//        final List<String> emojiSet = Arrays.asList("piłka️", "✂️", "✂️", "✂️", "✂️");
//
//
//        long result = emojiSet.stream().filter( uni -> allegroClient.getAllOffersByPhrase(uni, null)
//                .getOfferList().isEmpty()).count();
//        System.out.println(result);
////        System.out.println(result/emojiSet.size());
